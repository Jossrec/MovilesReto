...
interface ItemsRepository2 {
    fun getAllItemsStream(): Flow<List<Formulario_2>>
    fun getItemStream(id: Int): Flow<Formulario_2?>
    suspend fun insertItem(item: Formulario_2)
    suspend fun deleteItem(item: Formulario_2)
    suspend fun updateItem(item: Formulario_2)
}
